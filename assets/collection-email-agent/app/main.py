...
def main(host: str, port: int):
    skill = AgentSkill(
        ...
        description="An AI agent that drafts personalized collection emails based on customer payment history and outstanding AR items from SAP S/4HANA.",
        tags=["collection", "email", "accounts-receivable", "finance"],
        examples=["Draft a collection email for customer C1000 with overdue invoices", "List all customers with invoices overdue by more than 30 days"],
    )
